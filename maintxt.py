...
def crearArchivos(path, file):
    ...
    #----------------------------------------COMPROBANTES DC -------------------------------------------
    fileaux = path + "/M4T_COMPROBANTES_DC_33.txt"
    count =  7
    idcomprobante = 1
    rComprobantes = []
    if sheet_general.cell(row = count, column = 1).value != None:
        ...
        #----------------------------------------Fin Comprobante ----------------------------------------
    #----------------------------------------Nomina 12 -------------------------------------------
    fileaux = path + "/M4T_NOMINA12_CNR_33.txt"
    ...
    fileaux = path + "/M4T_PERCEPCIONES_CNP_33.txt"
    count =  7
    Listpercepciones = []
    idPercepciones = 1
    ...
    fileaux = path + "/M4T_PERCEPCION_NPD_33.txt"
    count =  7
    Listpercepcion = []
    idPercepcion = 1
    ...
    fileaux = path + "/M4T_DEDUCCIONES_CND_33.txt"
    count =  7
    Listdeducciones = []
    idDeducciones = 1
    ...
    if sheet_deduccion.cell(row = count, column = 1).value != None:
        ...
        #----------------------------------------FIN DE DEDUCCIONES -------------------------------------------
    #----------------------------------------INICIO DE DEDUCCION -------------------------------------------
    fileaux = path + "/M4T_DEDUCCION_NDD_33.txt"
    count =  7
    Listdeduccion = []
    idDeduccion = 1
    ...
    fileaux = path + "/M4T_OTROSPAGOS_NOP_33.txt"
    count =  7
    ListOtrosPagos = []
    idOtrosPagos = 1
    ...
    fileaux = path + "/M4T_INCAPACIDADES_CNI_33.txt"
    count =  7
    ListIncapacidades = []
    idIncapacidades = 1
